...
@WebServlet(name="cosmos", value="/cosmos")
public class CosmosServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String correctAnswer1 = "Юпітер";
        String correctAnswer2 = "Юпітер";
        String correctAnswer3 = "Сонце";
        String correctAnswer4 = "Меркурій";
        String correctAnswer5 = "Венера";
        String correctAnswer6 = "Юпітер";
        String correctAnswer7 = "Сатурн";
